...
from unionllm.providers.minimax import MinimaxAIProvider, MinimaxOpenAIError

class TestMinimaxAIProvider:
    @pytest.fixture(autouse=True)
    def setup_provider(self):
        # 从环境变量中导入API密钥
        self.provider = MinimaxAIProvider(api_key=os.getenv("MINIMAX_API_KEY"))
